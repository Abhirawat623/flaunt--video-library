...
export const PlaylistPage = () => {
  ...
  return (
    <div className="bg-blue">
      ...
      {token ?(loading ? <Skeleton />:<PlaylistContainer/>):(  <img src="https://i.ibb.co/16JPSyB/OIG4-w4j-LUt3dqi-JG-ZE11-removebg-preview.png" className="absolute top-1/2 left-1/2 translate z-15"/>)}
    </div>
  );
};
